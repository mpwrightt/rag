...
class EmbeddingGenerator:
    ...
    def __init__(
        ...
        self.model_configs = {
            ...
            # Gemini embeddings (Google AI Studio) use 768 dimensions
            # When using a non-OpenAI provider via an OpenAI-compatible gateway,
            # set EMBEDDING_MODEL=text-embedding-004 and VECTOR_DIMENSION=768
        ...
        # Allow environment override of embedding dimension to ensure DB compatibility
        try:
            ...
            # Do not fail initialization due to env parsing issues
            pass
